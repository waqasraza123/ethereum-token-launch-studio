...
const requiredPaths = [
  ...
  "apps/web/src/components/projects/project-detail-shell.tsx",
  "apps/web/src/components/workspaces/bootstrap-workspace-form.tsx",
  "apps/web/src/lib/auth/session.ts",
  "apps/web/src/lib/branding/site-metadata.ts",
  "apps/web/src/lib/env/public.ts",
  "apps/web/src/lib/env/server.ts",
  "apps/web/src/lib/env/public.test.ts",
  "apps/web/src/lib/env/server.test.ts",
  "apps/web/src/lib/projects/data.ts",
  "apps/web/src/lib/projects/input.ts",
  "apps/web/src/lib/projects/input.test.ts",
  ...
  "apps/web/src/lib/workspaces/bootstrap-input.ts",
  "apps/web/src/lib/workspaces/bootstrap-input.test.ts",
